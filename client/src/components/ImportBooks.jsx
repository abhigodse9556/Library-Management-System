  ...
  return (
    <div className="import-books-container">
      ...
      <div className="import-info">
        <p>
          Import books from the Frappe Library API. The API returns a maximum of
          20 books per page. You can specify search parameters to filter the
          results.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="import-form">
        <div className="form-group">
          ...
          />
          <small>
            Maximum 20 books per page. API will fetch multiple pages if needed.
          </small>
        </div>
